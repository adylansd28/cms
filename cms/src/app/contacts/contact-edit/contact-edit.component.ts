...
export class ContactEditComponent implements OnInit {
  ...
  ngOnInit() {
    this.route.params.subscribe (
      (params: Params) => {
        ...
        this.originalContact = this.contService.getContact(+this.id);
  ...
  onSubmit (form: NgForm) {
    ...
    let newContact = new Contact(this.id, value.name, value.email, value.phone, value.imageUrl, value.group);
